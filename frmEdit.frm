...
Begin VB.Form frmEdit 
   ...
   Begin VB.ComboBox txtBDAYDD 
      Height          =   315
      ItemData        =   "frmEdit.frx":0958
      Left            =   4800
      List            =   "frmEdit.frx":09B9
      TabIndex        =   14
      Top             =   5880
      Width           =   735
   End
   Begin VB.ComboBox txtProv 
      Height          =   315
      ItemData        =   "frmEdit.frx":0A30
      Left            =   120
      List            =   "frmEdit.frx":0AF7
      TabIndex        =   9
      Top             =   4440
      Width           =   3135
   End
   Begin VB.ComboBox txtCountry 
      Height          =   315
      ItemData        =   "frmEdit.frx":0E0E
      Left            =   120
      List            =   "frmEdit.frx":0F65
      TabIndex        =   10
      Top             =   5160
      Width           =   3135
   End
   ...
   Begin MSComctlLib.ImageList imgladd 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEdit.frx":1455
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEdit.frx":176F
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEdit.frx":1A89
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmEdit.frx":1DA3
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub Form_Load()
    ...
    txtEmail.Text = frmMain.txtEmail.Text
    txtPhone.Text = frmMain.txtPhone.Text
    txtCell.Text = frmMain.txtCell.Text
    txtPager.Text = frmMain.txtPager.Text
    txtStreet.Text = frmMain.txtStreet.Text
    txtCity.Text = frmMain.txtCity.Text
    txtProv.Text = frmMain.txtProv.Text
    txtCountry.Text = frmMain.txtCountry.Text
    txtCode.Text = frmMain.txtCode.Text
    txtBDAYMM.Text = frmMain.txtBDAYMM.Text
    txtBDAYDD.Text = frmMain.txtBDAYDD.Text
    txtBDAYYYYY.Text = frmMain.txtBDAYYYYY.Text
    txtComments.Text = frmMain.txtComments.Text
    txtURL.Text = frmMain.txtURL.Text
    txtFax.Text = frmMain.txtFax.Text
    txtPhoto.Text = frmMain.txtPhoto.Text
...
Do Until MyRecord.EOF
    If frmMain.lstNames.Text = MyRecord!Name Then
        frmMain.lstNames.RemoveItem (frmMain.lstNames.ListIndex)
        frmMain.lstNames.AddItem txtName.Text
    With MyRecord
        .Edit
